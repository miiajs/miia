...
| [`@miiajs/messaging-redis`](/docs/packages/messaging/redis) | experimental | 30 | Redis Streams transport + idempotency store. Untested at production load; XAUTOCLAIM crash-recovery test still TODO. |
