...
MiiaJS packages ship ES2025 code, and TC39 decorators are compiled by `tsc` itself - no `experimentalDecorators` flag, no `reflect-metadata`. Match your project to the same baseline:
